...
const API_URL = process.env.API_URL || 'http://api.dev2.aaa.mtabuscis.net';
const MAP_URL = process.env.MAP_URL || 'http://api.dev2.aaa.mtabuscis.net';
